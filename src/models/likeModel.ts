 ...
 * @returns data
 */
export const createLike = (idUser: number, idTarget: number) => {
 ...
 * @returns data
 */
export const getLikeByIdUserAndDateAndLimitToCatchLimitLike = (
  idUser: number,
  date: string,
  limit: number,
) => {
 ...
 * @returns data
 */
export const getLikeByIdUserAndDateAndLimitToCatchSameLikeUserInSameDay = (
  idUser: number,
  date: string,
  idUserTarget: number,
  limit: number,
